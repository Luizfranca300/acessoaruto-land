...
import { Car, Search, DollarSign, Award, ChevronRight, Phone } from 'lucide-react';
    ...
    <div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-xl md:text-2xl mb-8 text-red-50">
              Os melhores veículos seminovos com qualidade garantida e condições especiais de financiamento
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-bold mb-2 text-gray-800">Amplo Estoque</h3>
            ...
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-bold mb-2 text-gray-800">Financiamento Facilitado</h3>
              <p className="text-gray-600">
      ...
      {brands.length > 0 && (
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-center mb-12 text-gray-800">Marcas Disponíveis</h2>
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6">
              {brands.map((brand) => (
                ...
                >
                  <span className="text-gray-700 font-semibold text-center">{brand.name}</span>
                </button>
              ))}
            </div>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center mb-12">
            <h2 className="text-3xl font-bold text-gray-800">Veículos em Destaque</h2>
            <button
              onClick={() => onNavigate('inventory')}
      ...
      <section className="py-16 bg-gradient-to-br from-red-700 to-red-800 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 text-red-50 max-w-2xl mx-auto">
            Avaliamos seu veículo gratuitamente e oferecemos a melhor proposta do mercado
          </p>
          <button
            onClick={() => onNavigate('sell')}
