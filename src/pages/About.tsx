...
import { MapPin, Phone, Mail, Clock, Award, Users, Shield, CheckCircle } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="bg-gradient-to-br from-red-700 to-red-800 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Sobre a AutoGaragem</h1>
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-12">
          <div>
            ...
            <div className="space-y-4 text-gray-600 leading-relaxed">
              <p>
                A AutoGaragem nasceu do sonho de oferecer ao mercado uma experiência diferenciada na compra e venda de
                veículos seminovos. Com mais de 15 anos de atuação, nos consolidamos como referência em qualidade,
                transparência e atendimento personalizado.
              </p>
              <p>
                Nossa missão é conectar pessoas aos seus veículos ideais, oferecendo um processo simples, seguro e
                confiável. Cada veículo em nosso estoque passa por rigorosa vistoria técnica, garantindo a procedência e
                qualidade que nossos clientes merecem.
              </p>
              <p>
                Acreditamos que comprar um carro é mais do que uma transação comercial - é realizar um sonho, conquistar
                autonomia e abrir novas possibilidades. Por isso, tratamos cada cliente de forma única, entendendo suas
        ...
        <div className="bg-white rounded-lg shadow-md p-8 mb-12">
          <h2 className="text-3xl font-bold text-gray-800 mb-8 text-center">Nossos Diferenciais</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="font-bold text-gray-800 mb-2">Garantia Mecânica</h3>
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="font-bold text-gray-800 mb-2">Procedência Garantida</h3>
                <p className="text-gray-600 text-sm">Documentação completa e histórico transparente</p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">Experimente o veículo antes de comprar</p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="font-bold text-gray-800 mb-2">Financiamento Facilitado</h3>
                <p className="text-gray-600 text-sm">Parceria com principais instituições financeiras</p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="font-bold text-gray-800 mb-2">Retomamos seu Usado</h3>
                <p className="text-gray-600 text-sm">Avaliação justa e uso como parte do pagamento</p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="font-bold text-gray-800 mb-2">Atendimento Especializado</h3>
                <p className="text-gray-600 text-sm">Equipe treinada para orientar você na melhor escolha</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-lg shadow-md p-8">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  <MapPin size={24} className="text-red-700 flex-shrink-0 mt-1" />
                  <div>
                ...
                <div className="flex items-start gap-4">
                  <Phone size={24} className="text-red-700 flex-shrink-0 mt-1" />
                  <div>
                    <h3 className="font-bold text-gray-800 mb-1">Telefones</h3>
                    <p className="text-gray-600">
                      (34) 3235-3324
                      <br />
                      (34) 99888-4444 (WhatsApp)
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">contato@autogaragem.com.br</p>
                  </div>
                </div>

                <div className="flex items-start gap-4">
                  <Clock size={24} className="text-red-700 flex-shrink-0 mt-1" />
                  <div>
            ...
            <div className="bg-gradient-to-br from-red-700 to-red-800 text-white rounded-lg shadow-md p-8 text-center">
              ...
              <p className="mb-6 text-red-50">
                Venha conhecer nosso showroom e equipe. Teremos prazer em atendê-lo!
              </p>
              <a
