...
import { supabase, VehicleValuation } from '../lib/supabase';
...
export default function SellCar() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const { error } = await supabase.from('vehicle_valuations').insert([formData]);
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="bg-gradient-to-br from-red-700 to-red-800 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-red-50 max-w-2xl mx-auto">
            Avaliação gratuita e rápida. Oferecemos o melhor valor pelo seu veículo!
          </p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          <div>
            <h2 className="text-3xl font-bold text-gray-800 mb-6">Por que vender conosco?</h2>
            ...
            <div className="space-y-6 mb-8">
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-gray-800 mb-2">Avaliação Justa</h3>
                  <p className="text-gray-600">
                    Analisamos o mercado e oferecemos o melhor preço pelo seu veículo
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-gray-800 mb-2">Processo Rápido</h3>
                  <p className="text-gray-600">
                    Pagamento imediato e documentação facilitada. Você vende e recebe na hora!
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-gray-800 mb-2">Sem Burocracia</h3>
                  <p className="text-gray-600">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-gray-800 mb-2">Todas as Marcas</h3>
                  <p className="text-gray-600">
            ...
            <div className="bg-red-50 border-l-4 border-red-700 p-6 rounded-lg">
              <h3 className="text-lg font-bold text-red-900 mb-2">Como Funciona?</h3>
          ...
          <div className="bg-white rounded-lg shadow-md p-8">
            <h2 className="text-2xl font-bold text-gray-800 mb-6">Solicite sua Avaliação</h2>

            {submitSuccess ? (
              <div className="bg-green-50 border border-green-200 rounded-lg p-8 text-center">
                <CheckCircle size={64} className="text-green-600 mx-auto mb-4" />
                <h3 className="text-xl font-bold text-green-800 mb-2">Avaliação Solicitada!</h3>
                <p className="text-green-700 mb-6">
                  Recebemos sua solicitação. Nossa equipe entrará em contato em breve para agendar a vistoria.
                </p>
                <button
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent"
                  >
                    <option value="excellent">Excelente - Sem avarias, bem conservado</option>
                    <option value="good">Bom - Pequenas marcas de uso</option>
                    <option value="fair">Regular - Necessita pequenos reparos</option>
                    <option value="poor">Ruim - Necessita reparos significativos</option>
                  </select>
                </div>
