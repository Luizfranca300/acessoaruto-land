...
export default function Financing() {
  ...
  function calculateInstallment() {
    const financedAmount =
      simulationValues.vehiclePrice - simulationValues.downPayment;
    ...
    const installment =
      (financedAmount * rate * Math.pow(1 + rate, n)) /
      (Math.pow(1 + rate, n) - 1);
    return installment;
  }
      ...
      <div className="bg-gradient-to-br from-red-700 to-red-800 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-red-50 max-w-2xl mx-auto">
            Realize o sonho do seu carro novo com condições especiais e taxas
            competitivas
          </p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          <div className="bg-white rounded-lg shadow-md p-6 text-center">
            ...
            <p className="text-gray-600">
              A partir de 1,49% ao mês com as melhores condições do mercado
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 text-center">
            ...
            <p className="text-gray-600">
              Análise e aprovação de crédito em até 24 horas
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 text-center">
            ...
            <p className="text-gray-600">
              Prazos flexíveis para caber no seu bolso
            </p>
          </div>
        </div>
            ...
            <div className="space-y-6">
              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-2">
                  Valor do Veículo: R${" "}
                  {simulationValues.vehiclePrice.toLocaleString("pt-BR")}
                </label>
                <input
                  type="range"
                  min="20000"
              ...
              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-2">
                  Entrada: R${" "}
                  {simulationValues.downPayment.toLocaleString("pt-BR")}
                </label>
                <input
                  type="range"
                  min="0"
              ...
              <div className="bg-red-50 border-l-4 border-red-700 p-6 rounded-lg space-y-4">
                ...
                <div className="flex justify-between items-center py-4 border-t border-red-200">
                  ...
                  <span className="text-3xl font-bold text-red-700">
                    R${" "}
                    {monthlyInstallment.toLocaleString("pt-BR", {
                      minimumFractionDigits: 2,
                    })}
                  </span>
                </div>
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                <p className="text-xs text-gray-600">
                  * Simulação com taxa de juros de{" "}
                  {(interestRate * 100).toFixed(2)}% ao mês. Valores sujeitos à
                  aprovação de crédito. Taxas podem variar conforme análise
                  cadastral.
                </p>
              </div>
            </div>
              ...
              <div className="space-y-4">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Navegue pelo nosso estoque e escolha o carro ideal
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Use nossa calculadora para ver as condições de pagamento
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Analisamos seu perfil em até 24 horas
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Aprovado! Venha buscar seu novo veículo
                    </p>
                  </div>
                </div>
              </div>
